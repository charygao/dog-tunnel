...
var serverAddr = flag.String("remote", "", "connect remote server")
var serverBustAddr = flag.String("buster", "", "MakeHole server")
...
var clientMode = flag.Int("mode", 1, "just p2p mode")
